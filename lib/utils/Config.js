...
Config.prototype.parseArgs = function parseArgs() {
    var args = require('yargs')
        ...
        .option('json', {
            alias: 'j',
            describe: 'Run in json mode. Run the tests against all version and outputs the results to STD in json format.',
            type: 'boolean',
            default: undefined
        })
        .option('setup', {
        ...
        .option('yarn', {
            alias: 'y',
            describe: "Use yarn instead of npm to install packages.",
            type: 'boolean',
            default: undefined
        })
        .help('h')
